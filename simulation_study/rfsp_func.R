...
calculate_rfsp_predictions <- function(training_set, test_points, num.trees = 150, tolerance = .7) {
    ...
    resp_ranger <- ranger(fm0, rm.resp, quantreg=TRUE, num.trees=num.trees) 
